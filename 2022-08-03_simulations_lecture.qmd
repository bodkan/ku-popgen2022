...
## Compute Neanderthal ancestry trajectory using $f_4$-ratio statistic

1. Take your model of Neanderthal introgression

2. Implement temporal sampling of individuals:
"EUR" individuals (perhaps one genome every 1000 years between 40 kya and present-day)
...
ts_f4ratio(
  ts,
  X = '<vector of "European" individuals>',
  A = '<"Altai" individual>',
...
4. Plot the estimated trajectory of Neanderthal ancestry in Europe over the last 40 thousand years.
